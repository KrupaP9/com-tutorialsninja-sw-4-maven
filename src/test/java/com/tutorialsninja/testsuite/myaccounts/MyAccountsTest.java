...
public class MyAccountsTest extends BaseTest {
    ...
    public void verifyThatUserRegisterAccountSuccessfully()throws InterruptedException{
        ...
        registerPage.sendFirstName("Prime");
        //3.4 Enter Last Name
        registerPage.sendLastName("Testing");
        //3.5 Enter Email
        registerPage.sendEmail("prime");
        //3.6 Enter Telephone
        registerPage.sendTelephone("07612345678");
        //3.7 Enter Password
        registerPage.sendPassword("Passwordnum1");
        //3.8 Enter Password Confirm
        registerPage.sendConfirmPassword("Passwordnum1");
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully(){
        ...
        homePage.selectMyAccountOptions("Login");
        //4.3 enter email
        loginPage.sendEmail("primetesting885@gmail.com");
        //enter password
        loginPage.sendPassword("Passwordnum1");
        //click login
